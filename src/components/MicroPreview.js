...
class MicroPreview extends React.Component{
    ...
    render(){
        return(
            <div className="micro-container" style={{display:"flex", flexDirection: "column"}}> 
                ...
                <div className="title-wrapper" 
                    ...
                    textAlign:"center",  
                    marginTop:"1%",  
                    background: "linear-gradient(90deg, " + this.state.backgroundColor + " 0%, " + this.state.backgroundColor +" 100%)", 
                    width:"80%", 
                    border:"white", 
                    borderStyle:"solid", 
                    borderRadius:"15%"}}>
